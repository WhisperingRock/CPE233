...
HD_PWD='/home/whirck/Desktop/Sources/2026_Summer/CPE233/03_hardware/otter/MulticycleOtter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PC_TestBlock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PC_TestBlock.tcl
