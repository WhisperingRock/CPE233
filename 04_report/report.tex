		...
		\subsection{HW4 - ALU + ImmGen}
			...
			\subsubsection{ALU}
				...
				\lstinputlisting[
					language={Verilog},
					captionpos=top,
					caption={Verification testing for ALU: \texttt{ALU\_tb.sv}},
					breaklines=false,
					label={fig:rf}
			...
			\subsubsection{Immediate Generator}
				...
				\lstinputlisting[
					language={Verilog},
					captionpos=top,
					caption={Verification testing for ImmedGen: \texttt{ImmedGen\_tb.sv}},
					breaklines=false,
					label={fig:rf}
		...
		\subsection{HW5 - Real Memory and Branch}
			...
			\subsubsection{Branch Condition Generator}
				...
				\lstinputlisting[
					language={Verilog},
					captionpos=top,
					caption={\texttt{BranchConditionGen.sv}},
					breaklines=false,
					label={fig:BCG}
				...
				\lstinputlisting[
					language={Verilog},
					captionpos=top,
					caption={\texttt{BranchConditionGen\_tb.sv}},
					breaklines=false,
					label={fig:BCGtb}
			...
			\subsubsection{Branch Address Generator}
				...
				\lstinputlisting[
					language={Verilog},
					captionpos=top,
					caption={\texttt{BranchAddrGen.sv}},
					breaklines=false,
					label={fig:BAG}
				...
				\lstinputlisting[
					language={Verilog},
					captionpos=top,
					caption={\texttt{BranchAddrGen\_tb.sv}},
					breaklines=false,
					label={fig:BAGtb}
